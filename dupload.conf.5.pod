...
For the E<quot>copyE<quot> method, this option is ignored and the local
FQDN will be used intead.

=item B<method> [optional]

The transfer method. The available methods are: E<quot>ftpE<quot>
(which is the default), E<quot>scpE<quot>, E<quot>scpbE<quot>,
E<quot>rsyncE<quot> (over SSH) and E<quot>copyE<quot> (local filesystem).

If you are using an upload queue, use FTP because it is fast.
