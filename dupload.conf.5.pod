...
(which is the default), B<https>, B<http>, B<scp>, B<scpb>,
B<rsync> (over SSH) and B<copy> (local filesystem).
...
=item B<distwhitelist> [optional, deprecated] (since 2.9.3)
...
=item B<distblacklist> [optional, deprecated] (since 2.9.3)
...
=item B<mailto> [optional, deprecated]
...
=item B<mailtx> [optional, deprecated]
