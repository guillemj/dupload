...
=item F<package>.announce,

=item F<package_UPSTREAMVER>.announce, or

=item F<package_UPSTREAMVER-DEBIANREV>.announce

=back

exist, these files get
...
=head2 ftp / http / https / scp / rsync / copy

The default transfer method is B<ftp>.
Alternative methods are B<http>, B<https>, B<scp>/SSH, B<rsync>/SSH and
B<copy>.
...
=item I<package>.announce

=item I<package_upstreamver>.announce

=item I<package_upstreamver-debianrev>.announce
...
=item I<package_version-revision_arch>.upload
